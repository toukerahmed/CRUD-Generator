<x-layout>
        <div class="w3-container w3-padding-32 mt-5">
            <h1 class="w3-border-bottom w3-border-light-grey w3-padding-16 mb-4">Edit {{ $order->id }}</h1>
        </div>
                    ...
                    <div class="form-group">
                            ...
                            @foreach($options as $option)
                                <div class="form-check">
                                    <input type="radio"
                                        ...
                                        {{ old($field['name'], $order[$field['name']]) == trim($option) ? 'checked' : '' }}>
                        ...
                        @else
                            <input type="text"
                                ...
                                name="{{ $field['name'] }}"
                                id="{{ $field['name'] }}"
                                value="{{ old($field['name'], $order[$field['name']]) }}">
                        @endif
